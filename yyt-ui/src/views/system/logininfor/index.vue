<template>
  <div class="app-container">
    ...
    <el-table ref="tables" height="450" v-loading="loading" :data="list" @selection-change="handleSelectionChange" :default-sort="defaultSort" @sort-change="handleSortChange">
