  ...
  <div class="app-container">
    <el-form :model="queryParams" ref="queryForm" size="small" :inline="true" v-show="showSearch" label-width="68px">
      ...
      <el-form-item label="费用状态" prop="status">
        <el-select v-model="queryParams.status" placeholder="请选择费用状态" clearable>
          <el-option
    ...
    <el-row :gutter="10" class="mb8">
      ...
      <el-col :span="1.5">
        <el-button
          ...
          size="mini"
          @click="handleExport"
          v-hasPermi="['os:expense:export']"
        >导出</el-button>
      </el-col>
      <right-toolbar :showSearch.sync="showSearch" @queryTable="getList"></right-toolbar>
    </el-row>

    <el-table v-loading="loading" height="500" :data="expenseList" @selection-change="handleSelectionChange">
      ...
      <el-table-column label="费用状态" align="center" prop="status">
...
<script>
import { listExpense, getExpense, delExpense, addExpense, updateExpense } from "@/api/os/expense";
...
export default {
  ...
  data() {
    return {
      ...
      rules: {
        ...
        status: [
          { required: true, message: "费用状态不能为空", trigger: "change" }
        ],
      }
    };
  },
  ...
  methods: {
    ...
    /** 导出按钮操作 */
    handleExport() {
      this.download('os/expense/export', {
        ...this.queryParams
